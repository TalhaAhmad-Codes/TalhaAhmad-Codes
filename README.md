...
### 📂 Featured Projects
- 🔸 [**Pizza X**](https://github.com/TalhaAhmad-Codes/pizza-x) — Enterprise-grade backend-focused multi-frontend POS & CRM system implementing layered clean architecture with EF.
